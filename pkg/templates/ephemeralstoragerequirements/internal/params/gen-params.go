...
`)
	...
	lowerBoundGBParamDesc = util.MustParseParameterDesc(`{
	"Name": "lowerBoundGB",
	"Type": "integer",
	"Description": "The lower bound of the requirement (inclusive), specified as a number of GB.",
	"Examples": null,
	"Enum": null,
	"SubParameters": null,
	"ArrayElemType": "",
	...
	"NoRegex": false,
	"NotNegatable": false,
	"XXXStructFieldName": "LowerBoundGB",
	"XXXIsPointer": false
}
`)

	upperBoundGBParamDesc = util.MustParseParameterDesc(`{
	"Name": "upperBoundGB",
	"Type": "integer",
	"Description": "The upper bound of the requirement (inclusive), specified as a number of GB. If not specified, it is treated as \"no upper bound\".",
	"Examples": null,
	"Enum": null,
	"SubParameters": null,
	"ArrayElemType": "",
	...
	"NoRegex": false,
	"NotNegatable": false,
	"XXXStructFieldName": "UpperBoundGB",
	"XXXIsPointer": true
}
`)
	...
	ParamDescs = []check.ParameterDesc{
		...
		lowerBoundGBParamDesc,
		upperBoundGBParamDesc,
	}
)
